...
az network private-endpoint create --resource-group $vnetRG --vnet-name $vnetName --subnet $subnetName --name blob-pewu --private-connection-resource-id "<AZRESOURCEID>" --group-id blob --connection-name blobconn01 --location $region